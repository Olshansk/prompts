Below is the README from tobi's (Shopify CEO) for a side project.

IMO it's a masterclass in how to write a README.

Use it as a reference for editing and providing on other READMEs in the future
when you run within a certain project.
